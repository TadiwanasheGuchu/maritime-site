...
/**
 * Lightweight, dependency-free icon set. Paths mirror the lucide icons used in
 * the source design (stroke-based, 24x24, round caps) so we avoid pulling in an
 * icon package while keeping the visual language identical.
 */
function Icon({
  size = 24,
  children,
...
export function Waves(props: IconProps) {
  return (
    <Icon {...props}>
      <path d="M2 6c.6.5 1.2 1 2.5 1C7 7 7 5 9.5 5c2.5 0 2.5 2 5 2 1.3 0 1.9-.5 2.5-1" />
...
export function MedKit(props: IconProps) {
  return (
    <Icon {...props}>
